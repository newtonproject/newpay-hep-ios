#
#  Be sure to run `pod spec lint NewPaySDK-iOS.podspec' to ensure this is a
...
Pod::Spec.new do |spec|
  ...
  spec.description  = "NewPay SDK for login and saving order info on chain"
  ...
  # Or just: spec.author    = "Yiwei Heng"
  # spec.authors            = { "Yiwei Heng" => "hengyiwei@diynova.com" }
  # spec.social_media_url   = "https://twitter.com/Yiwei Heng"
